# Generated by Django 2.2 on 2021-03-04 19:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_by', models.ManyToManyField(blank=True, related_name='favorite_recipes', through='recipes.Favorites', to=settings.AUTH_USER_MODEL)),
                ('ingredients', models.ManyToManyField(related_name='recipe', through='recipes.Ingredient', to='recipes.Product')),
            ],
            options={
